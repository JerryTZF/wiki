...
::: tip 注意
这里我只介绍工作流中最常使用的一些操作和命令，以及多人开发中应当遵循的规范和如何协同开发。以下以 `Github` 示例。\
如果感兴趣，超级建议仔细阅读 `Github` 的 [官方文档](https://docs.github.com/zh/get-started)。
:::
